export const experiences = [
  {
    ...
    highlights: [
      ...
      {
        tag: 'BACKEND · BDD',
        text: 'APIs RESTful y creación de procedimientos almacenados en BDD.',
      },
  ...
  },
  {
    ...
    highlights: [
      ...
      {
        tag: 'COMPONENTES',
        text: 'Librería de componentes reutilizables con consistencia visual.',
      },
  ...
  },
  {
    ...
    highlights: [
      ...
      {
        tag: 'HERRAMIENTAS',
        text: 'Automatización de scripts y optimización interna del área comercial.',
      },
    ],
    projects: [
...
export const workProjects = [
  {
    ...
    link: 'https://.app',
    description:
      'Desarrollo de la landing page principal de Consultants in Blockchain, diseñada para representar la identidad de la empresa en el ecosistema cripto y destacar sus servicios. Implementación de una interfaz moderna y atractiva alineada con el sector blockchain.',
  ...
  },
  {
    ...
    description:
      'Proyecto personal e integrador que busca reconectar a las personas con la naturaleza de su región. Facilita la exploración de rutas de trekking, hiking, humedales y áreas verdes cercanas a la ciudad, promoviendo la desconexión del entorno urbano y el redescubrimiento de espacios naturales. Además, destaca la presencia de fauna autóctona poco común en entornos urbanos, fomentando la conservación y el respeto por estos ecosistemas.',
