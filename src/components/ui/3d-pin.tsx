            ...
            <div className="relative w-full h-full flex justify-center items-center">
                ...
                >
                    <div
                        ...
                        className="absolute left-1/2 w-[24rem] h-[22rem] -top-3 p-4 flex justify-center items-center rounded-2xl shadow-[0_8px_16px_rgb(0_0_0/0.4)] bg-black border border-white/[0.1] group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden"
                    >
...
const PinPerspective: React.FC<PinPerspectiveProps> = ({
    ...
    return (
        <motion.div className="pointer-events-none w-[10rem] h-[auto] flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
