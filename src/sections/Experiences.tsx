      ...
      <div className="flex items-center gap-2.5">
        ...
        {isActive ? (
          <span className="flex items-center gap-1.5">
            ...
            />
            <span className="font-mono text-[8px] text-textPrimary/60 tracking-[0.2em] uppercase">
              ACTIVE
            </span>
          </span>
        ) : (
          <span className="flex items-center gap-1.5">
            ...
            <span className="font-mono text-[8px] text-gray-600 tracking-[0.2em] uppercase">
              ARCHIVED
            </span>
          </span>
        )}
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="absolute top-0 left-0 right-0 h-px bg-linear-to-r from-transparent via-textPrimary/40 to-transparent" />
          ...
          <div className="relative p-5 md:p-6 flex-1" style={DOT_BG}>
            ...
            <div className="mb-4">
              <p className="font-mono text-[8px] text-textPrimary/30 tracking-[0.25em] uppercase mb-1">
                CARGO
              </p>
            ...
            <ul className="space-y-2.5">
              {exp.highlights.map((h, i) => (
                <li key={i} className="flex items-start gap-2 text-sm">
                  <span className="text-textPrimary/50 shrink-0 mt-0.75 text-xs">▸</span>
                  <span className="text-gray-400 leading-relaxed font-mono text-[12px] tracking-wide">
                    {h.text}
                  </span>
                </li>
              ))}
        ...
        >
          <div className="absolute top-0 left-0 right-0 h-px bg-linear-to-r from-transparent via-textPrimary/70 to-transparent" />
          <CardHeader exp={exp} index={index} />
          <div className="relative p-5 md:p-6 flex-1" style={DOT_BG}>
            <div className="flex items-center gap-3 mb-3">
              ...
              <ul className="space-y-1.5">
                {exp.projects.map((p, i) => (
                  <li key={i} className="flex items-center gap-2 font-mono text-xs text-gray-400">
                    <span className="text-textPrimary/40">
        ...
        {experiences.map((exp, index) => (
          ...
          >
            <div className="shrink-0 w-10 flex justify-center">
              <div className="mt-5.5 w-3 h-3 rounded-full border-2 border-textPrimary bg-background shadow-[0_0_10px_#d28fff88] z-10" />
            </div>
